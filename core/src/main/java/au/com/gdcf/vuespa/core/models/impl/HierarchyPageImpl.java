...
public class HierarchyPageImpl implements HierarchyPage {
   ...
   */
  private static final String HIERARCHY_ENTRY_POINT_PAGE_ATTR = "com.adobe.aem.guides.vuespa.core.models.impl.entryPointPage";
  ...
  private <T> Map<String, T> getChildPageModels(@Nonnull SlingHttpServletRequest slingRequest,
    ...
    Page rootPage = currentPage.getAbsoluteParent(pageTreeTraversalDepth);

    List<Page> childPages = getChildPageRecursive(rootPage, slingRequestWrapper, pageFilterPatterns, pageTreeTraversalDepth);
